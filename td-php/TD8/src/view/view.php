    ...
    <nav>
        <ul>
            ...
            if (ConnexionUtilisateur::estConnecte()) {
                echo '<a href="frontController.php?controller=utilisateur&action=deconnecter">
                                    <span class="material-symbols-outlined">logout</span>
                                  </a>
                                  <a href="frontController.php?controller=utilisateur&action=read&login='
                    . ConnexionUtilisateur::getLoginUtilisateurConnecte() .'">
                                    <span class="material-symbols-outlined">account_circle</span>
                                  </a>';
            } else {
                echo '<a href="frontController.php?controller=utilisateur&action=formulaireConnexion">
